...
![Centered Pairs plot](cpp.png){width=100%}
![Non-centered Pairs plot](ncppp.png){width=100%}
...
![Centered model trace plot](tpc.png){width=100%}
![Non-centered model trace plot](tpncp.png){width=100%}
